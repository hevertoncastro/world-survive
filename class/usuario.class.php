...
class Usuario extends UsuarioVO{
	...
	public function inserirUsuario(UsuarioVO $dados){
		...
		$sql = "INSERT INTO usuarios(usu_id,usu_nome,usu_email,usu_senha,usu_cep,usu_endereco,usu_numero,usu_complemento,usu_bairro,usu_cidade,usu_estado,usu_lat,usu_lng,usu_celular,usu_inclusao,usu_ativo) VALUES (";
	...
	public function alterarUsuario(UsuarioVO $dados) {
		...
		$sql .=  "usu_lat = '".$dados->getLatitude()."', ";
		$sql .=  "usu_lng = '".$dados->getLongitude()."', ";
